...
import com.mqunar.domain.NetworkData;
import com.mqunar.logging.AgentLog;
import com.mqunar.logging.AgentLogManager;
import com.mqunar.network.instrumentation.httpclient.HttpRequestEntityImpl;
import com.mqunar.network.instrumentation.httpclient.HttpResponseEntityImpl;
...
//    private static final String REQUEST_HEADER_HOST= "Host";
    ...
    public static void end(TransactionState transactionState) {
        ...
        if(networkData != null && !networkData.excludeImageData() && !networkData.excludeIllegalData()) {
            Storage.newStorage(QAPM.mContext).putData(networkData, NetworkDataParse.newInstance());
        }
    }
}
